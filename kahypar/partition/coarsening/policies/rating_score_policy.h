...
namespace kahypar {
    ...
    private:
        ...
        static constexpr RatingType boxcox_transform[] = {
                -0.19401318752826535, -0.022742996530458, -0.08076547562124864, -0.32272110830116896,
                -1155.864789069469,
                -0.19867993808387394, -0.03137435505859718, -0.08239606314997686, -0.3605154066247999,
                -1126.491302599712,
                -0.20386761187748023, -0.04196020184016822, -0.0836640118255222, -0.3939291738258216,
                -1093.0029606267874,
                -0.21019872452650798, -0.05508660704289518, -0.08567347720341494, -0.43712723571147527,
                -1048.8370752197309};
    ...
    private:
        ...
        // F17, F22, F24
        static constexpr RatingType weights[] = {
                0.13435066338988, 0.365922771270246, 0.310982810156622, // k=2
                0.167566869029696, 0.374496792248546, 0.213955555909499, // k=4
                0.20367415085197, 0.362917730049415, 0.052211517864925, // k=8
                0.237586192818919, 0.357445569336664, -0.060422606505837}; // k=16
        static constexpr RatingType boxcox_transform[] = {
